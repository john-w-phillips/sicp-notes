...
**** Applying compiled procedures
     ...
     label proc-return and jumps to the procedure's entry point. The
     ...
     specified by the linkage. (The linkage is always return or label,
     because compile-procedure-call replaces a next linkage for the
     compound-procedure branch by an after-clal label.)
