...
**** Execution procedures for subexpressions     
	 ...
	 (test-b
	  ...
	  gcd-done)
       ...
       How exactly we assemble is in some ways not that important it
       seems. The instructions accomplish the exact same things -- I
       had to change more than the syntax procedures _but_ 
